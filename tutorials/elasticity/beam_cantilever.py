...
def main():
    ...
    M = ff.assemble_beam_mass(coords, conn, section, format=args.format)
    ...
    print(f"beam solved: format={args.format}, solver={solver}, nodes={coords.shape[0]}, elems={conn.shape[0]}, dofs={n_dofs}")
