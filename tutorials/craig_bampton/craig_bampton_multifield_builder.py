...
def main() -> None:
    ...
    adapter = system.contact_pair_adapter("interface_candidate")
    print(f"contact params:       {adapter.params}")
    print(f"slave reduced DOFs:   {adapter.slave_reduced_dofs.tolist()}")
    print(f"master reduced DOFs:  {adapter.master_reduced_dofs.tolist()}")
